    ...
    <header className="fixed top-0 w-full z-40 bg-[#fcfcfd]/90 backdrop-blur-md border-b border-zinc-200/80 transition-colors">
      <div className="max-w-6xl mx-auto px-6 sm:px-8 lg:px-12 h-16 flex items-center justify-between gap-6">
        ...
        <div className="flex items-center gap-3 shrink-0">
          ...
          >
            <div className="w-6 h-6 bg-zinc-900 rounded-[5px] flex items-center justify-center transition-transform duration-300 group-hover:scale-105 shadow-2xs">
              <div className="w-2.5 h-2.5 bg-zinc-100 rotate-45 transition-transform duration-300 group-hover:rotate-90"></div>
            </div>
            <span className="font-bold text-[16px] tracking-tight uppercase text-zinc-900 font-sans">
              INDEX
            </span>
          </button>
          <span className="font-mono text-[11px] font-medium bg-zinc-100 text-zinc-600 px-1.5 py-0.5 rounded-[4px] border border-zinc-200/70">
            v1.0
          </span>
        </div>
        ...
        <div className="flex-1 max-w-md hidden md:block" ref={containerRef}>
          <div className="relative flex items-center group">
            ...
            <input
              ...
              className="w-full h-9 pl-10 pr-12 bg-zinc-50/80 hover:bg-zinc-100/70 focus:bg-white border border-zinc-200/90 rounded-md text-[13px] text-zinc-900 placeholder:text-zinc-400 focus:outline-none focus:border-zinc-950 focus:ring-2 focus:ring-zinc-950/10 transition-all duration-200 font-sans"
            />
            ...
            {inputValue ? (
              ...
              <button
                ...
                className="absolute right-3 font-mono text-[10px] text-zinc-500 bg-white border border-zinc-200 px-1.5 py-0.5 rounded shadow-2xs cursor-pointer hover:bg-zinc-50 transition-colors"
