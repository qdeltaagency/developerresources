    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 sm:p-6 bg-zinc-950/40 backdrop-blur-xs animate-card">
      ...
      >
        ...
        <div className="p-5 sm:p-6 overflow-y-auto flex-1 flex flex-col gap-5">
          {/* Tool Real Screenshot Banner */}
          {tool.image && (
            <div className="relative w-full h-48 sm:h-56 rounded-lg overflow-hidden border border-zinc-200/80 bg-zinc-950 shadow-inner group">
              <img
                src={tool.image}
                alt={tool.name}
